var MountainIndustries = function(game) {};

MountainIndustries.prototype = {
    preload: function() {
    ...
    , create: function() {
        ...
        //buildings
        this.oceanBldgData = ResourceMap.getLocationBldgs('mountain');
...
Phaser.Utils.mixinPrototype(MountainIndustries.prototype, mixins);