var PrairieIndustries = function(game) {};

PrairieIndustries.prototype = {
    preload: function() {
    ...
    , create: function() {
        ...
        //buildings
        this.oceanBldgData = ResourceMap.getLocationBldgs('prairie');
...
Phaser.Utils.mixinPrototype(PrairieIndustries.prototype, mixins);