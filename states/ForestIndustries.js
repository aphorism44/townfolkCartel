var ForestIndustries = function(game) {};

ForestIndustries.prototype = {
    preload: function() {
    ...
    , create: function() {
        ...
        //buildings
        this.oceanBldgData = ResourceMap.getLocationBldgs('forest');
...
Phaser.Utils.mixinPrototype(ForestIndustries.prototype, mixins);