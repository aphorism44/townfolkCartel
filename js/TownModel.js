...
(function(window){
    ...
    function define_town_model() {
        ...
        TownModel.addAdventurers = function(num, cost) {
            this.moneyPool -= cost;
            for (var i = 0; i < num; i++)
        ...
        TownModel.goAdventuring = function() {
        ...
        TownModel.getOverview = function() {
    ...
    if(typeof(TownModel) === 'undefined'){
        window.TownModel = define_town_model();
    }
    else{
        console.log("TownModel already defined.");
    }
})(window);